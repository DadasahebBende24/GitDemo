...
public class StandaloneTest {
	...
	public static void main(String[] args) {
		...
		driver.findElement(By.id("userEmail")).sendKeys("dvbende@gmail.com");
		driver.findElement(By.id("userPassword")).sendKeys("Learning@1234");
		...
		driver.findElement(By.xpath("//button[contains(@class,'ta-item') and contains(.,'India')]")).click();
